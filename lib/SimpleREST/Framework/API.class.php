...
class API {
	...
	static public function run ($routes) {
		...
		try {
			...
			if(!$resource) {
				throw new \SimpleREST\HTTPError(404, "resource-not-found");
			}
			...
			if (!API::isMethod($method)) {
				throw new \SimpleREST\HTTPError(405, "method-not-supported");
			}

			if (!method_exists($resource, $method)) {
				throw new \SimpleREST\HTTPError(405, "no-method");
			}
